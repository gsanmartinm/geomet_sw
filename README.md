...
- Importa y visualiza **superficies y geometrías DXF** (topografía, diseños de mina, sólidos), con control de color y transparencia en vivo.
...
- Paletas de color (Rainbow, Viridis, Magma, Coolwarm), leyendas arrastrables, grilla de referencia con cotas/coordenadas en vistas ortogonales, brújula y gizmo de ejes X/Y/Z.
...
index.css           Estilos
js/app.js           Orquestador principal (eventos de UI, estado, filtros)
js/scene.js         Escena Three.js: cámaras, render de capas, secciones, ejes
